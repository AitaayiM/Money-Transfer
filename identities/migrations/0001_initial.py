# Generated by Django 5.1 on 2024-08-28 23:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Sender', 'Sender'), ('Receiver', 'Receiver'), ('Agent', 'Agent')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, related_name='users', to='identities.role')),
            ],
            options={
                'verbose_name': 'user',
